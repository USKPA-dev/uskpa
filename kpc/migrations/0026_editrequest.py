    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country_of_origin', django_countries.fields.CountryField(blank=True, max_length=746, multiple=True, verbose_name='Country of Origin')),
                ...
                ('certificate', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='kpc.Certificate')),
                ...
                ('reviewed_by', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='reviewed_edit_requests', to=settings.AUTH_USER_MODEL)),
            ],
            options={
